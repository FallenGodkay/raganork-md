...
module.exports = {
    VERSION: 'v4.0.0',
    ALIVE: process.env.ALIVE || "https://telegra.ph/file/9e786bdd2538b87c995c8.jpg Hey {sender}, I'm alive \n Uptime: {uptime}",
    ...
    STICKER_DATA: process.env.STICKER_DATA || "「Ø₮Ⱡ」ØɄ₮Ⱡ₳₩Ƶ",
    BOT_NAME: process.env.BOT_NAME || '「Ø₮Ⱡ」Legend♡',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'ꪶ͢٭𝑺𝜣𝑼𝑹𝛢𝑽𝑲𝑳¹¹ꫂ;Raganork MD bot;https://telegra.ph/file/9e786bdd2538b87c995c8.jpg' : process.env.AUDIO_DATA,
